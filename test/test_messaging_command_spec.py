"""Contract tests for the shared command GRAMMAR (``messaging/command_spec.py``).
...
from kiro_crew.messaging.command_spec import CommandSpec, build_help_text, match_command
